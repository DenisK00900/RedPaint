...
namespace RedPaint
{
    public class CircleRender : AbstrShaderTex
    {
        ...
        public override void Generate()
        {
            ...
            if (Effect == null)
            {
                Effect = mc.Content.Load<Effect>("Shaders/CircleUtility");
            }
            ...
            Effect.Parameters["radiusPixels"].SetValue(((float)rsize)/2f - thickness);
        ...
        public CircleRender(Maincode imc) : base(imc)
        {
        }
    }
}
