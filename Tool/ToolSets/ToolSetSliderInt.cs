...
namespace RedPaint
{
    public class ToolSetSliderInt : ToolSet, IDrawable
    {
        ...
        public override ToolSetSliderInt Clone()
        {
            ToolSetSliderInt clone = new ToolSetSliderInt(mc, parent);
        ...
        public override void Update(float deltaTime)
        {
            ...
            value = (int)Math.Round(MathHelper.Lerp(minV, maxV, slider.lean));

            (visual[1] as Text).text = $"{value}";
        ...
        public ToolSetSliderInt(Maincode imc, AbstrEntity pr = null) : base(imc, pr)
        {
