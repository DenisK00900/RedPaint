...
namespace RedPaint
{
    public class Text : VisualElement
    {
        ...
        { 
            ...
            if (TUH.InsideScreen(isAbsolute ? pos : parent.GetPos() + pos, parent.mc._data, Math.Max(font.MeasureString(text).X * scale.X, font.MeasureString(text).Y * scale.Y)))
            {
