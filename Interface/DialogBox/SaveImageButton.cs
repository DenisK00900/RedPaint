...
namespace RedPaint
{
    public class SaveImageButton : SpriteButton
    {
        ...
        public SaveImageButton(Maincode imc, AbstrEntity pr = null) : base(imc, pr)
        {
